...
function CompanySearchResultsModal({ name, taille, starsCount, imageSrc }) {
  ...
  return (
    <div className="p-6 bg-white mt-10 h-auto rounded-md flex flex-col items-start w-[95%] m-4 border hover:shadow-lg hover:border-[#003761] cursor-pointer transition ease-in-out 000ms hover-slide-up">
     ...
     <div className="flex items-start w-full p-3">
      ...
      <div className="flex flex-col w-full mt-4">
        ...
        <div className="flex">{renderStars(starsCount)}
        </div>
